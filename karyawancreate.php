...
<?php
        ...
        $insertSql = "INSERT INTO praktikum_presensi_penggajian.pengguna VALUES (NULL, ?, ?, ?, NULL)";
        ...
        if ($stmt->execute()) {
          ...
          $insertKaryawanSql = "INSERT INTO praktikum_presensi_penggajian.karyawan VALUES (NULL, ?, ?, ?, ?, ?, ?)";
          ...
          $_SESSION['hasil'] = false;
          $_SESSION['pesan'] = "Simpan Data GAGAL!";
          //$_SESSION['pesan'] = "Gagal Simpan Data Karyawan";
        }
