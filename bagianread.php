        ...
        <div class="card-body">
          <table id="mytable" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              "SELECT 
              B.*, 
              K.nama_lengkap nama_kepala_bagian, 
              L.nama_lokasi nama_lokasi_bagian 
              FROM praktikum_presensi_penggajian.bagian B
              LEFT JOIN praktikum_presensi_penggajian.karyawan K ON B.karyawan_id = K.id
              LEFT JOIN praktikum_presensi_penggajian.lokasi L ON B.lokasi_id = L.id";
