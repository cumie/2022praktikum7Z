    ...
    <div class="content">
      <div class="card">
        <div class="card-header">
          ...
          <a href="export/penggajianrekap-perbulan-pdf.php?tahun=<?= $_GET['tahun'] ?>" target="_blank" class="btn btn-success btn-sm float-right">
          ...
          <table class="table table-bordered table-hover" id="mytable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="?page=penggajianrekap-perkaryawan&tahun=<?= $_GET['tahun'] ?>&bulan=<?= $row['bulan'] ?>" class="btn btn-info btn-sm mr-1">
