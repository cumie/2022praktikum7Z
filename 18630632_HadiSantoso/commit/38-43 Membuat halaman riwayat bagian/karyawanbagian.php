              ...
              <div class="form-group">
                ...
                <select name="bagian_id" id="" class="form-control">
                  ...
                  <?php 
                    ...
                    $selectSQL = mysqli_query($conn, "SELECT * FROM bagian") or die (mysqli_error($conn));
                      while($row_bagian = mysqli_fetch_array($selectSQL)) {
                      echo '
                      <option value="'.$row_bagian['id'].'">
                        '.$row_bagian['nama_bagian'].'
                      </option>
                      ';
                      }
                  ?>
