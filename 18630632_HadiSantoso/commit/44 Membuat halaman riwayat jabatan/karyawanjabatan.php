      ...
      <div class="card-body">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <select name="jabatan_id" id="" class="form-control">
                  ...
                  <?php 
                    $conn = mysqli_connect("localhost", "root", "", "praktikum_presensi_penggajian");
                    $selectSQL = mysqli_query($conn, "SELECT * FROM jabatan") or die (mysqli_error($conn));
                      while($row_jabatan = mysqli_fetch_array($selectSQL)) {
                      echo '
                      <option value="'.$row_jabatan['id'].'">
                        '.$row_jabatan['nama_jabatan'].'
                      </option>
                      ';
                      }
                  ?>
        ...
        <table id="mytable" class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              <td><?= $no++ ?></td>
              <td><?= $rowjabatan['nama_jabatan'] ?></td>
              <td><?= $rowjabatan['tanggal_mulai'] ?></td>
              <td>
                <form action="" method="post">
                  <input type="hidden" name="jk_id" value="<?= $rowjabatan['id'] ?>">
