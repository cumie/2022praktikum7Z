    ...
    <div class="content">
      <div class="card">
        <div class="card-header">
          ...
          <a href="export/penggajianrekap-pdf.php" target="_blank" class="btn btn-success btn-sm float-right">
          ...
          <table class="table table-bordered table-hover" id="mytable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="?page=penggajianrekap-perbulan&tahun=<?= $row['tahun'] ?>" class="btn btn-info btn-sm mr-1">
