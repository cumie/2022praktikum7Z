...
if (isset($_GET['page'])) {
  ...
  switch ($page) {
    ...
    case 'penggajianrekap';
      ...
      break;
    case 'penggajianrekap-perbulan';
      file_exists('pages/admin/penggajianrekap-perbulan.php') ? include 'pages/admin/penggajianrekap-perbulan.php' : include "pages/404.php";
      break;
    case 'penggajianrekap-perkaryawan';
      file_exists('pages/admin/penggajianrekap-perkaryawan.php') ? include 'pages/admin/penggajianrekap-perkaryawan.php' : include "pages/404.php";
      break;
