...
if (isset($_GET['id'])) {
  ...
  $id = $_GET['id'];
  $findSql = "SELECT * FROM praktikum_presensi_penggajian.bagian WHERE id = ?";
  ...
  if (isset($row['id'])) {
    ...
    if (isset($_POST['button_update'])) {
      ...
      $validateSql = "SELECT * FROM praktikum_presensi_penggajian.bagian WHERE nama_bagian = ? AND id != ?";
      ...
      if ($stmt->rowCount() > 0) {
        ...
        $updateSql = "UPDATE praktikum_presensi_penggajian.bagian SET 
                        nama_bagian = ?,
                        karyawan_id = ?,
                        lokasi_id = ?
                        WHERE id = ?";
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="lokasi_id">
                ...
                <?php
                  $database = new Database();
                  $db = $database->getConnection();
                  $selectSQL = "SELECT * FROM praktikum_presensi_penggajian.lokasi";
